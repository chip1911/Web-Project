...
<body style="max-width: 1170px;
    ...
    <div id = "wrapper">
        <div class = "titleOfPage">
            <h2>
                <i><b>Sách tâm linh - tôn giáo</b></i>
            </h2>
        </div>
    </div>
    <?php
    ...
    $take_SQL = "SELECT *FROM product WHERE productLine = 'Sách tâm linh - tôn giáo';";
                ...
                <div class="product-item">
                    <div class = "product-top">
                        ...
                        <div class="container">
                            ...
                            <a href="add_to_cart.php?idP=<?php echo $row['productCode']; ?>" class="buy-now"><b>Mua ngay</b></a>
                        </div>
                        
                    </div>
                    <div class="product-info">
                        <a href="#" class="product-cat"><?php echo $row['productLine']; ?></a>
            ...
            <li>
                <div class="product-item">
                    <div class = "product-top">
                        ...
                        <div class="container">
                            <a href="add_to_cart.php?idP=<?php echo $row['productCode']; ?>" class="cart-shopping">&#x1F6D2</a>
                            <a href="#" class="buy-now"><b>Mua ngay</b></a>
                        </div>
